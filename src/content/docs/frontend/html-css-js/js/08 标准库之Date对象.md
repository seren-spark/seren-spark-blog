---
title: "08 标准库之Date对象"
description: "08 标准库之Date对象：前端知识库章节。"
sidebar:
  order: 8
---
...
```js
Date()
// "Tue Dec 01 2021 09:34:43 GMT+0800 (CST)"
```
...
var d3 = new Date('2020-06-01');	
// 算时区，中国为东八区
console.log(d3);	
// Mon Jun 01 2020 08:00:00 GMT+0800 (中国标准时间)
```
...
**获取时间戳的方法，分别为 new Date().getTime() 和 Date.now() 和  +new Date()**
